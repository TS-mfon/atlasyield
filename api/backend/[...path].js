const PRIMARY_API_ORIGIN =
  (process.env.PRIMARY_API_ORIGIN || process.env.VPS_API_ORIGIN || "http://172.236.110.179:4411").replace(/\/$/, "");
const FALLBACK_API_ORIGIN =
  (process.env.FALLBACK_API_ORIGIN || process.env.RENDER_API_ORIGIN || "https://atlasyield-api-fallback.onrender.com").replace(/\/$/, "");
